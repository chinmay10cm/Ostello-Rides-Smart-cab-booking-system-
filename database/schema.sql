-- ============================================================
-- OSTELLO RIDES — Database Schema  v2
...
CREATE TABLE IF NOT EXISTS users (
    ...
    pin_hash    TEXT,                                  -- SHA-256 hex of 4-digit PIN
...
INSERT OR IGNORE INTO system_locations (label, icon, lat, lon) VALUES
  ('Ostello (Parsik Hill)',        '🏠', 19.0176, 73.0360),
  ...
  ('Seawoods Central Mall',        '🛍', 19.0024, 73.0142),
  ...
  ('MIDC Nerul',                   '🏭', 19.0350, 73.0180),
  ('Paras Defence & Space Tech',   '🛰', 19.0175, 73.0208),
...
INSERT OR IGNORE INTO users (name, phone, room_number, role, pin_hash) VALUES
  ('Admin',   '9999999999', NULL, 'admin',
   '9af15b336e6a9619928537df30b2e6a2376569fcf9d7e773eccede65606529a0'),
  ('Driver1', '9888888881', NULL, 'driver',
...
-- -- ============================================================
-- -- OSTELLO RIDES — Database Schema(older  version)
-- -- SQLite (MVP) | Upgrade path: PostgreSQL + PostGIS
-- -- ============================================================
